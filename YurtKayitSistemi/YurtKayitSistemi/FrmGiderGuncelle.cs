...
namespace YurtKayitSistemi
{
    public partial class FrmGiderGuncelle : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("update Giderler set Elektrik=@p1,Su=@p2,Dogalgaz=@p3,internet=@p4,Gida=@p5,Personel=@6,Diger=@p7 where Odemeid=@p8", bgl.baglanti());
